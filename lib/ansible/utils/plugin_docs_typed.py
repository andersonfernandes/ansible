...
from typing import Any, Dict, List, MutableMapping, MutableSequence, MutableSet, Tuple, Union, Callable
...
def merge_fragment(target: MutableMapping, source: MutableMapping) -> None:
...
def _process_versions_and_dates(fragment: MutableMapping, is_module: bool, return_docs: bool, callback: Callable) -> None:
    def process_deprecation(deprecation: MutableMapping, top_level: bool = False) -> None:
    ...
    def process_option_specifiers(specifiers: List[MutableMapping]) -> None:
    ...
    def process_options(options: MutableMapping) -> None:
    ...
    def process_return_values(return_values: MutableMapping) -> None:
    ...
    def process_attributes(attributes: MutableMapping) -> None:
...
def add_collection_to_versions_and_dates(fragment: MutableMapping, collection_name: str, is_module: bool, return_docs: bool = False) -> None:
    def add(options: MutableMapping, option: Any, collection_name_field: str) -> None:
...
def remove_current_collection_from_versions_and_dates(fragment: MutableMapping, collection_name: str, is_module: bool, return_docs: bool = False) -> None:
    def remove(options: MutableMapping, option: Any, collection_name_field: str) -> None:
...
def add_fragments(doc: MutableMapping, filename: str, fragment_loader: Any, is_module: bool = False) -> None:
...
def get_docstring(filename: str, fragment_loader: Any, verbose: bool = False, ignore_errors: bool = False, collection_name: str = None, is_module: bool = None, plugin_type: str = None) -> Tuple[MutableMapping, List[str], MutableMapping, MutableMapping]:
...
def get_versioned_doclink(path: str) -> str:
    path = to_native(path)
    try:
...
def _find_adjacent(path: Path, plugin: str, extensions: List[str]) -> List[str]:
    adjacent = Path(path)
...
def find_plugin_docfile(plugin: str, plugin_type: str, loader: Any) -> Tuple[str, str]:
...
def get_plugin_docs(plugin: str, plugin_type: str, loader: Any, fragment_loader: Any, verbose: bool) -> Tuple[MutableMapping, List[str], MutableMapping, MutableMapping]:
    docs = []
